...
secgroups = ['default', 'wywiol_nsg']

print("Creating instance ... ")
instance = nova.servers.create(name="celeryWorker"+str(identifier), image=image, flavor=flavor, userdata=userdata, nics=nics,security_groups=secgroups)
